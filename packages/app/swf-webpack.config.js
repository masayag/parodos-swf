...
// TODO Move it outside of app package as well as package.json dependencies, envelop directory, tsconfig.json
// TODO Figure how to use swf editor separate building step
module.exports = () => {
  return {
    mode: 'development',
