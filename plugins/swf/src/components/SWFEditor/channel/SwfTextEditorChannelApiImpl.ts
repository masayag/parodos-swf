...
import { SwfTextEditorChannelApi } from './SwfTextEditorChannelApi';

export class SwfTextEditorChannelApiImpl implements SwfTextEditorChannelApi {
  constructor(
  ...
  public kogitoNotifications_createNotification(
    ...
    this.args.defaultApiImpl.kogitoNotifications_createNotification(
      notification,
    );
  }
  ...
  public kogitoWorkspace_resourceContentRequest(
    request: ResourceContentRequest,
  ): Promise<ResourceContent | undefined> {
    return this.args.defaultApiImpl.kogitoWorkspace_resourceContentRequest(
      request,
    );
  }

  public kogitoWorkspace_resourceListRequest(
    request: ResourceListRequest,
  ): Promise<ResourcesList> {
    return this.args.defaultApiImpl.kogitoWorkspace_resourceListRequest(
      request,
    );
  }
  ...
  public kogitoSwfServiceCatalog_services(): SharedValueProvider<
    SwfServiceCatalogService[]
  > {
    return (
      this.args.swfServiceCatalogApiImpl?.kogitoSwfServiceCatalog_services() ?? {
        defaultValue: [],
      }
    );
  }
  ...
  public kogitoSwfServiceCatalog_importFunctionFromCompletionItem(args: {
    ...
    this.args.swfServiceCatalogApiImpl?.kogitoSwfServiceCatalog_importFunctionFromCompletionItem(
      args,
    );
  }
  ...
  public async kogitoSwfLanguageService__getCompletionItems(args: {
    ...
    return (
      this.args.swfLanguageServiceChannelApiImpl?.kogitoSwfLanguageService__getCompletionItems(
        args,
      ) ?? []
    );
  }
  ...
  public async kogitoSwfLanguageService__getCodeLenses(args: {
    ...
    return (
      this.args.swfLanguageServiceChannelApiImpl?.kogitoSwfLanguageService__getCodeLenses(
        args,
      ) ?? []
    );
  }
  ...
  public kogitoSwfTextEditor__onSelectionChanged(_: {
    nodeName: string;
  }): void {
    // no-op
  }
